            ...
            <MainContainer>
                    ...
                    >
                        ...
                        {(
                            this.state.showGallery ?
                                ...
                                >
                                    <div className="gallery_title">{this.state.galleryDesc.title}</div>
                                    <div className="gallery_date">{this.state.galleryDesc.date}</div>
                                ...
                                <PageTitle
                                    ...
                                    data-aos-easing="ease-in-out"
                                >
                                    Avicia Fernandes is an Illustrator living in Mumbai, India <br />who believes imagination can change the world.
                                    </PageTitle>
                        )}
                        <Divider />
                    </div>
                ...
                <FlexRow style={{ marginBottom: 20, display: (this.state.showGallery ? "none" : "flex") }}>
                    ...
                    <FlexCol style={boxNavs} onClick={() => setFolder('Poster')}>
                        ...
                        <div className="onhover-red boxes" style={card_caption}>The Examiner</div>
                    </FlexCol>
